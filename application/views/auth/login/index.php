...
<html lang="en">
  <head>
    ...
    <!-- Font Awesome -->
    <link href=".<?php echo base_url('assets')?>/node_modules/gentelella/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="<?php echo base_url('assets')?>/node_modules/gentelella/vendors/nprogress/nprogress.css" rel="stylesheet">
    <!-- Animate.css -->
    <link href="<?php echo base_url('assets')?>/node_modules/gentelella/vendors/animate.css/animate.min.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="<?php echo base_url('assets')?>/node_modules/gentelella/build/css/custom.min.css" rel="stylesheet">
  </head>
